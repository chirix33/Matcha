      ...
      {job.applyLink && (
        <div className="mt-6 pt-4 border-t border-gray-200">
          <a
            ...
            className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-matcha-primary text-white font-semibold rounded-lg hover:bg-matcha-secondary transition-colors shadow-sm hover:shadow-md"
          >
            Apply Now
            <svg
